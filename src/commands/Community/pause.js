...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (!member.voice.channelId == guild.members.me.voice.channelId) {
            embe.setColor('#8b02e0').setDescription(`You can't use the music player as it is already active in <#${guild.members.me.voice.channelId}>`);
            return interaction.reply({ embeds: [embed], ephemeral: true });
        }
        ...
        try {
            ...
            embed.setColor('#8b02e0').setDescription("⏸ The song has been paused.");
            return interaction.reply({ embeds: [embed], ephemeral: true });
