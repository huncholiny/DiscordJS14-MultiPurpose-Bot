    ...
    data: new SlashCommandBuilder()
        ...
        .addSubcommand(subcommand =>
            subcommand.setName("pause")
                .setDescription("️️Pauses a giveaway.")
                .addStringOption(option =>
        ...
        .addSubcommand(subcommand =>
            subcommand.setName("unpause")
                .setDescription("️️Unpauses a giveaway.")
                .addStringOption(option =>
                    option.setName("message-id")
                        .setDescription("Specify giveaway message-id.")
                        .setRequired(true)
        ...
        .addSubcommand(subcommand =>
            subcommand.setName("end")
                .setDescription("️️Ends a giveaway.")
                .addStringOption(option =>
                    option.setName("message-id")
                        .setDescription("Specify giveaway message-id.")
                        .setRequired(true)
        ...
        .addSubcommand(subcommand =>
            subcommand.setName("reroll")
                .setDescription("️️Selects a new giveaway winner.")
                .addStringOption(option =>
                    option.setName("message-id")
                        .setDescription("Specify giveaway message-id.")
                        .setRequired(true)
        ...
        .addSubcommand(subcommand =>
            subcommand.setName("delete")
                .setDescription("️️Deletes the giveaway.")
                .addStringOption(option =>
                    option.setName("message-id")
                        .setDescription("Specify giveaway message-id.")
                        .setRequired(true)
